...
См. также: скрипты автоматической установки серверов [OpenVPN](https://github.com/hwdsl2/openvpn-install/blob/master/README-ru.md) и [IPsec VPN](https://github.com/hwdsl2/setup-ipsec-vpn/blob/master/README-ru.md).
